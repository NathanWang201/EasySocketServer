...
public class Test {
	public static void main(String args[]) throws Exception {
		BlockingModeServer blockingModeServer = BlockingModeServer.getInstance();
		blockingModeServer.setUpPool(0,4,"").addPort(9000, new Handler() {
			@Override
		...
		map = blockingModeServer.showStatus();
